...
from LieuLe.Baitap8_9_10.utils.json_reader import read_json
...
class LoginFooterComponent:
    ...
    def verify_twitter_page(self, twitter_page):
        ...
        expect(twitter_page.locator(self.X_ICON)).to_be_visible()
    
        # 2️⃣ Verify OrangeHRM text under avatar
        expect(twitter_page.locator(self.ORANGEHRM_TEXT)).to_have_text("OrangeHRM")
